import { getConstraintViolations } from './requirementConstraints';
...
> = {
   ...
   */
  readonly getAllCoursesThatCanPotentiallySatisfyRequirement: (requirement: Requirement) => readonly number[];
};

export const buildRequirementFulfillmentGraph = <Requirement extends string, Course extends CourseForRequirementGraph>({
  requirements,
  userCourses,
...
>(
  ...
  const { constraintViolationsGraph, courseToRequirementsInConstraintViolations, doubleCountedCourseUniqueIDSet } =
