 ...
 */
export default class RequirementFulfillmentGraph<Requirement extends string, Course extends CourseWithUniqueId> {
  ...
  public subtractGraphEdges(graph: RequirementFulfillmentGraph<Requirement, CourseWithUniqueId>): void {
    graph.getAllEdges().forEach(([req, course]) => {
