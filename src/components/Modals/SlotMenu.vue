<template>
  <teleport-modal content-class="content-slotmenu" :isSimpleModal="true" @modal-closed="closeCurrentModal"
    :hasClickableTransparentBackground="true" :hasCustomPosition="true" :position="position">
    <button class="slotMenu-section full-opacity-on-hover" @click="openEditSlotModal">
      <div class="slotMenu-row">
        <div class="slotMenu-left">
          <img class="slotMenu-icon" src="@/assets/images/edit.svg" alt="edit requirement pencil icon" />
    ...
    <button class="slotMenu-section full-opacity-on-hover" @click="openDeleteSlotModal">
      <div class="slotMenu-row">
        <div class="slotMenu-left">
          <img class="slotMenu-icon" src="@/assets/images/trash.svg" alt="delete requirement trashcan icon" />
