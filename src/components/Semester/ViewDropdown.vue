<template>
  <div v-click-outside="close" class="dropdown" :data-intro-group="dataIntroGroup" :data-intro="dataIntro"
    :data-disable-interaction="dataDisableInteraction" :data-step="dataStep" :data-tooltipClass="dataTooltipClass">
    ...
    <div v-if="open" class="dropdown-content">
      <view-dropdown-option alt="not compact" :selected="!compact" :image="defaultSem" label="Default"
        @click="$emit('click-compact', false)" />
      <view-dropdown-option alt="compact" :selected="compact" :image="compactSem" label="Compact"
...
import { setOrderByNewest } from '@/firebase/semesters';
