        ...
        <div class="advisors-content">
            ...
            <div v-for="(advisor, index) in advisors" :key="index" class="advisors-row">
                ...
                <a class="advisors-info, advisors-email" :href="'mailto:' + advisor.email">
                    {{ advisor.email }}
                    <img class="advisors-email-icon" src="@/assets/images/link-gray.svg" alt="external link" />
                </a>
            </div>
        </div>
    </div>
...
import { AdvisorPackage } from '@/requirements/toolTypes';
import getAdvisor from '@/requirements/toolUtils';
