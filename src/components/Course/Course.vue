<template>
  <div :class="{
    ...
    <edit-color :editedColor="editedColor" @color-course="colorCourse" @color-subject="colorSubject"
      @close-edit-color="closeEditColorModal" v-if="isEditColorOpen" />
    <div class="course-color" :style="cssVars" :class="{
    ...
    <course-menu v-if="menuOpen" :semesterIndex="semesterIndex" :isCompact="compact" :courseColor="courseObj.color"
      @open-edit-color-modal="openEditColorModal" @delete-course="deleteCourse" @edit-course-credit="editCourseCredit"
      :getCreditRange="getCreditRange || []" v-click-outside="closeMenuIfOpen" />
  </div>
</template>
