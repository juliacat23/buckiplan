<template>
  <div class="course-tooltip">
    <div class="course-iconWrapper" :class="{ 'course-iconWrapper--verticalBar': !hideVerticalBar }">
      <img class="course-icon course-icon--caution" :src="icon" :alt="alt" />
    </div>
    <div class="course-tooltiptext" :class="{ 'course-tooltiptext--verticalBar': !hideVerticalBar }">
      <slot />
    </div>
  </div>
</template>
