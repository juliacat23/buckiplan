<template>
  <div class="completedsubreqcourse">
    <delete-course-modal :isTransferCredit="isTransferCredit" :reqName="courseTaken.code" v-if="deleteModalVisible"
    ...
    <div class="completed-reqCourses-course-wrapper">
      ...
      <div class="completed-reqCourses-course-heading-wrapper">
        <div class="completed-reqCourses-course-heading-course">
          <course-caution v-if="isCourseConflict(courseTaken.uniqueId)" :course="courseTaken" :isCompactView="false" />
          <span v-else class="completed-reqCourses-course-heading-check"><img src="@/assets/images/checkmark-green.svg"
              alt="checkmark" /></span>
          {{ slotName }}
        </div>
      ...
      <div class="completed-reqCourses-course-object-wrapper">
        <req-course :color="courseColor" :courseCode="courseTaken.code" :compact="true" :isCompletedReqCourse="true"
          :isConflict="isCourseConflict(courseTaken.uniqueId)" class="completed-reqCourses-course-object" />
        <div class="completed-reqCourses-course-object-semester">in {{ semesterLabel }}</div>
      </div>
    </div>
    <slot-menu v-if="slotMenuOpen" :position="slotMenuPosition" @open-delete-slot-modal="onDeleteModalOpen"
...
import { deleteCourseFromSemesters, deleteTransferCredit } from '@/firebase';
