<template>
  <div class="incompleteselfcheck">
    <new-self-check-course-modal v-if="isCourseModalOpen" :subReqName="subReqName" :requirementId="subReqId"
      @add-course="addNewCourse" @close-course-modal="closeCourseModal" />
    ...
    <div class="dropdown-select-wrapper">
      ...
      <div class="dropdown-content" v-if="showDropdown">
        <div v-for="optionName in Object.keys(selfCheckCourses)" :key="optionName" class="dropdown-content-item"
...
export default defineComponent({
  ...
  methods: {
    ...
    addNewCourse(course: OSUCourse, season: FirestoreSemesterSeason, year: number) {
      this.showDropdown = false;
      const newCourse = osuCourseToFirebaseSemesterCourseWithGlobalData(course);
      addCourseToSemester(
        year,
        season,
        newCourse,
