<template>
  <button @click="$emit('on-toggle')" class="dropdown row slightly-lower-opacity-on-hover" aria-haspopup="true"
    data-toggle="dropdown" data-cyId="requirements-displayToggle">
    <div class="row depth-req">
      <div class="btn">
        <drop-down-arrow :isFlipped="displayDescription" :fillColor="isCompleted ? '#979797CC' : '#979797'"
          :isSubReq="true" />
      </div>
