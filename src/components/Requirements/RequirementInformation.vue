<template>
  <div>
    <requirement-description :requirementFulfillment="requirementFulfillment" :choice="modelValue" :color="color"
      @update-choice="choice => $emit('update:modelValue', choice)" />
    <div v-if="requirementFulfillment.requirement.checkerWarning" class="requirement-checker-warning">
      <img class="requirement-checker-warning-icon" src="@/assets/images/warning.svg" alt="warning icon" />
      {{ requirementFulfillment.requirement.checkerWarning }}
    </div>
    <div v-if="requirementFulfillment.requirement.fulfilledBy === 'self-check'" class="requirement-checker-warning">
      <img class="requirement-checker-warning-icon" src="@/assets/images/warning.svg" alt="warning icon" />
