  ...
  <div class="requirement-fulfillment-slots">
    <div v-for="(requirementFulfillmentCourseSlot, id) in requirementCoursesSlots" :key="id">
      <div v-if="requirementFulfillmentCourseSlot.isCompleted">
        <completed-sub-req-course :slotName="requirementFulfillmentCourseSlot.name"
          :courseTaken="requirementFulfillmentCourseSlot.courses[0]" />
      </div>
      <div v-if="!requirementFulfillmentCourseSlot.isCompleted">
        <incomplete-sub-req-course :subReq="requirementFulfillment" :slotName="requirementFulfillmentCourseSlot.name"
          :courses="requirementFulfillmentCourseSlot.courses.slice(0, 4)" :displayDescription="displayDescription"
...
import { getMatchedRequirementFulfillmentSpecification } from '@/requirements/requirementUtils';
import { osuCourseToFirebaseSemesterCourseWithCustomIDAndColor } from '@/userDataConverter';
import { fullCoursesJson } from '@/constants/courses/typed-full-courses';
